...
export const API_TWO_FACTOR_VERIFY_URL = ['put', API + 'users/{user}/two-factor/authentication']
export const API_TWO_FACTOR_DISABLE_URL = ['delete', API + 'users/{user}/two-factor/authentication']
