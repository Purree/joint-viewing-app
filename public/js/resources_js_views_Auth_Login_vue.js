...
/* harmony import */ var _mixins_usePending__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @/mixins/usePending */ "./resources/js/mixins/usePending.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_loginUser__WEBPACK_IMPORTED_MODULE_6__["default"], _mixins_usePending__WEBPACK_IMPORTED_MODULE_7__["default"]],
  data: function data() {
    return {
      pending: false,
      loggedIn: false,
  ...
  methods: {
    ...
    tryToLogin: function tryToLogin() {
      ...
      var logoutAndRetryOnForbidden = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      return axios__WEBPACK_IMPORTED_MODULE_0___default().get('/sanctum/csrf-cookie').then(function () {
        return axios__WEBPACK_IMPORTED_MODULE_0___default().post(_api_auth__WEBPACK_IMPORTED_MODULE_1__.API_LOGIN_URL, _this.form).then(function (response) {
          ...
          if (logoutAndRetryOnForbidden && errors.response.status === 403) {
            return axios__WEBPACK_IMPORTED_MODULE_0___default().post(_api_auth__WEBPACK_IMPORTED_MODULE_1__.API_LOGOUT_URL).then(function () {
              return _this.tryToLogin(false);
            })["catch"](function (logoutErrors) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["is-loading", "pending", "form"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_router_link, {
    to: {
      'name': 'ForgotPassword'
    }
  }, {
